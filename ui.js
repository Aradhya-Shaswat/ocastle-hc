...
export function drawAchievement(ctx, W, H, state){
  try{
    ...
    const text = (state && state.achievement && state.achievement.message) ? state.achievement.message : 'Like this game? Checkout: retro-hc.vercel.app!';
    const maxTextW = bw - (iconSize + 40);
